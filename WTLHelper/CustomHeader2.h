...
class CCustomHeader2Parent :
	public CWindowImpl<CCustomHeader2Parent>,
	public CCustomDraw<CCustomHeader2Parent> {
public:
	BEGIN_MSG_MAP(CCustomHeader2Parent)
	...
	DWORD OnItemPrePaint(int /*idCtrl*/, LPNMCUSTOMDRAW cd) {
		...
		auto color = DarkMode::getBackgroundColor();
